package com.edt.ut3.refactored.models.services.authentication
...
class AuthenticatorUT3Service(
    val client: HttpClient,
    host: String
) : AbstractAuthenticator(host) {
    ...
    override suspend fun checkCredentials(credentials: Credentials) {
        ensureAuthentication(credentials, injected())
    }
    ...
    private suspend fun authenticate(credentials: Credentials, targetClient: HttpClient) {
        Log.d(this@AuthenticatorUT3Service::class.simpleName, "Trying authentication to https://$host")
        ...
        Log.d(this@AuthenticatorUT3Service::class.simpleName, "Authentication successful: $authenticationSuccessful")
